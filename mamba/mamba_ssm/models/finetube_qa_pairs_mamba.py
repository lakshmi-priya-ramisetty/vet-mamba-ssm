...
# checkpoint_path_model = '/scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/retrain_checkpoints/checkpoint-186138'
checkpoint_path_model = '/scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/retrain_checkpoints/checkpoint-517075'
checkpoint_path_qa_pairs = "/scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/mamba_finetune_results/checkpoint-600"
...
training_args = TrainingArguments(
    output_dir="/scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/mamba_finetuned_results_1.4b",
    num_train_epochs=3,
    per_device_train_batch_size=8,
    logging_dir='/scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/mamba_finetuned_results_1.4b',
    logging_steps=100,
    learning_rate=2e-3,
    disable_tqdm=False,
    save_steps=100, 
...
print(eval_results)
output_path = "/scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/mamba_finetuned_results_1.4b/eval_results.json"
with open(output_path, "w") as f:
    json.dump(eval_results, f, indent=4)

# CUDA_VISIBLE_DEVICES=6,7 python /scratch/vetgpt/vetgpt-rlp/mamba/mamba_ssm/models/finetube_qa_pairs_mamba.py